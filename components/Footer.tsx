        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div>
            <ul className="space-y-1.5 md:space-y-2 text-sm md:text-base">
              ...
              <li>
                <Link to="/careers" className="hover:underline transition-all font-medium">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            <ul className="space-y-1.5 md:space-y-2 text-sm md:text-base">
              ...
              <li>
                <Link to="/partner" className="hover:underline transition-all font-medium">
                  Partner with us
                </Link>
              </li>
              <li>
                <a href="https://drive.google.com/file/d/1d0RZ3Po3JJQ5iWg0KAwuWiMQai3FmSB9/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:underline transition-all">
                  Case Studies
                </a>
              </li>
            </ul>
