...
const PartnersSection = () => {
  return (
    <section className="py-16 md:py-24 bg-cream border-t border-moss/5">
      <div className="container mx-auto px-6 text-center">
          <motion.div
              ...
              viewport={{ once: true }}
          >
              <p className="text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] text-moss/50 mb-12 md:mb-16 font-bold">Strategic Alliances</p>
